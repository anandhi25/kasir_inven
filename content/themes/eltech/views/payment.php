<div id="content">
    ...
    <section class="padding-bottom-60">
        <div class="container">
            ...
            <!-- Button -->
            <div class="pro-btn"> <a href="<?php echo base_url('cart');?>" class="btn-round btn-light">Keranjang belanja</a> <a href="#" onclick="save_payment();" class="btn-round">Alamat Pengiriman</a> </div>
        </div>
    </section>
</div>
