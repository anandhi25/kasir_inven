...
class MY_Controller extends CI_Controller
{
    ...
    public function __construct()
    {
       ...
       // $this->load->helper('form');
        ...
        $this->session->set_userdata('user_roll',$all_menu);
       ...
       /* if (in_array(uri_string(), $exception_uris) == true) {
        ...
        if(!empty($notify_product)) {
            $this->session->set_userdata('notify_product',$notify_product);
           // $_SESSION["notify_product"] = $notify_product;
        }else{
            $this->session->set_userdata('notify_product',null);
        ...
        $this->session->set_userdata('pending_order',$pending_order);
    ...
    public function tbl_brand($order_by){
        $this->global_model->_table_name = 'tbl_brand';
        $this->global_model->_order_by = $order_by;
        $this->global_model->_primary_key = 'brand_id';
    }
    ...
    public function tbl_outlet($order_by){
        $this->global_model->_table_name = 'tbl_outlets';
        $this->global_model->_order_by = $order_by;
