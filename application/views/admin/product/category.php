                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    if (!empty($category_info->cat_icon)) {
                                        echo $category_info->cat_icon;
                                    }
                                    ?>">
                                    <div class="fileinput fileinput-new"  data-provides="fileinput">
                                        <div class="fileinput-new thumbnail g-logo-img" >
                                            <?php if (!empty($category_info->cat_icon)): // if product image is exist then show  ?>
                                                <img src="<?php echo base_url() . $category_info->cat_icon; ?>" >
                                        ...
                                        <div>
                                                    <span class="btn btn-default btn-file">
                                                        <span class="fileinput-new">
                                                            <input type="file" name="cat_icon" /></span>
