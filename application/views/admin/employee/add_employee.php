                    ...
                    <div class="row">
                        <div class="col-md-5 col-md-offset-1 border-right">
                            <div class="box-body">
                                ...
                                <?php
                                $display = 'none';
                                if($employee_login_details->flag == '0')
                                {
                                    $display = 'block';
                                }
                                ?>

                                <div class="form-group" id="div_outlet" style="display: <?php echo $display; ?>;">
                                    <label for="exampleInputPassword1">Outlet</label>
                                    <select id="outlet" name="outlet_id" class="form-control">
                                        <?php
                                        if(!empty($outlet_info))
                                        {
                                            ...
                                            {
                                                $sel = '';
                                                if($employee_login_details->outlet_id == $outlet->id)
                                                {
                                                    $sel = 'selected';
                                                }
