        ...
        <div class="box-tools pull-right">
            ...
            <div class="box-tools">
                <div class="btn-group" role="group" >
                    <a onclick="print_invoice('printableArea')" class="btn btn-default ">Print Invoice</a>
                    ...
                    <main >
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="unit"><?php echo number_format($v_product->unit_price, 0); ?></td>
                                <td class="qty"><?php echo $v_product->qty ?></td>
                                <td class="total"><?php echo number_format($v_product->sub_total,0) ?></td>
                            </tr>
                                <?php $counter ++?>
                            <?php endforeach; ?>
                            </tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $currency.' '.number_format($purchase->subtotal,0) ?></td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                                <td colspan="2">DISKON</td>
                                <td><?php echo $currency.' '.number_format($purchase->discount_amount,0) ?></td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                                <td colspan="2">PAJAK</td>
                                <td><?php echo $currency.' '.number_format($purchase->tax,0) ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><?php echo $currency.' '.number_format($purchase->grand_total,0) ?></td>
                            </tr>
                            <?php
                            if($purchase->payment_method == 'kredit') {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $currency . ' ' . number_format($purchase->down_payment, 0) ?></td>
                                </tr>
                                <?php
                            }
                            ?>
