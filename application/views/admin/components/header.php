...
<html>
    <head>
        ...
        <!-- Data Table  CSS -->
        <link href="<?php echo base_url(); ?>asset/js/plugins/datatables/dataTables.bootstrap.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>asset/js/plugins/datatables/jquery.dataTables.css" rel="stylesheet" type="text/css" />
