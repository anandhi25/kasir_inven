...
?>
        ...
        <!-- Logo -->
        <a href="<?php echo base_url(); ?>" class="logo"><b><?php echo $info->company_name; ?></b></a>
          ...
          <!-- Navbar Right Menu -->
            ...
            <div class="navbar-custom-menu pull-right">
                <ul class="nav navbar-nav">
                    ...
                    <?php
                    if(!empty($this->session->userdata('notify_product')))
                    {
                        $notify_product = $this->session->userdata('notify_product');
                    ...
                    <?php
                    $pending_order = $this->session->userdata('pending_order');
