        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-background">
                    <!-- form start -->
                    <form role="form" class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/report/purchase" autocomplete="off" method="post">
...
<script>
    ...
    $('#order_table').DataTable({
        ...
        aaSorting: [[0, 'desc']],
        "ajax": {
            url: '<?php echo base_url("admin/report/filter_purchase_tables");?>',
            "data": function (d) {
